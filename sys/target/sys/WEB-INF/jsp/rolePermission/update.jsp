...
<div class="pd-20">
    <form action="">   
                        ...
                        <td>                       	
                        	<input type="checkbox" name="permissionIds" value="${permissions.id }"  
	                        	<c:forEach var="rolePermission" items='${rolePermissions }'>
		                        	<c:if test='${permissions.id eq rolePermission.permissionId }'>checked="checked"</c:if>
		                        </c:forEach>
	                       />                        	                    	                        	                      		
                        </td>
        ...
        <br>
        <input class="btn btn-primary radius" type="button" value="分配权限" onclick="updatePermission(${roleId})" />
