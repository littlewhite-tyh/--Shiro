    ...
    <table class="table table-border table-bordered table-bg table-hover">
        <thead>
            <tr>
                ...
                <th>状&nbsp;&nbsp;态</th>
                <th>操&nbsp;&nbsp;作&nbsp;&nbsp;&nbsp;&nbsp;
					<shiro:hasPermission name="adminUser:add"><button class="btn size-MINI btn-secondary radius" onclick="window.location='adminUserAdd.go'"> 添加</button>
        ...
        <tbody>
        	<c:forEach var="adminUser" items="${adminUserList}">
                <tr>
                    ...
                    <c:choose>
                    	<c:when test="${adminUser.isDisabled}">
                    ...
                    <td>
                        ...
                        <button class="btn size-MINI btn-danger radius" onclick="adminUserDel(${adminUser.id},${adminUser.isDisabled})">删除</button>&nbsp;
						</shiro:hasPermission>
						<shiro:hasPermission name="adminUser:updatePassWord">
                        <button class="btn size-MINI btn-secondary radius" onclick="updatePassword(${adminUser.id})">重置密码</button>&nbsp;
						</shiro:hasPermission>
                        <shiro:hasPermission name="adminUser:updateAdminUserRole">
                        <button class="btn size-MINI btn-secondary radius" onclick="window.location='updateAdminUserRole.go?adminUserId=${adminUser.id}'">分配角色</button>&nbsp;
						</shiro:hasPermission>
						<shiro:hasPermission name="adminUser:updateDisabled">
                        <button class="btn size-MINI btn-warning radius" onclick="window.location='updateAdminUserDisabled.do?adminUserId=${adminUser.id}'">禁用/启用</button>
						</shiro:hasPermission>
                    </td>
                </tr>
             </c:forEach>  
